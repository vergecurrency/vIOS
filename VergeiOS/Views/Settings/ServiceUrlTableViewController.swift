...
class ServiceUrlTableViewController: UITableViewController {
    ...
    var previousServiceUrl: String = ApplicationManager.default.walletServiceUrl
    ...
    @IBAction func saveServiceUrl(_ sender: Any) {
        ...
        previousServiceUrl = ApplicationManager.default.walletServiceUrl
        ApplicationManager.default.walletServiceUrl = serviceUrlTextField.text!

        WalletTicker.shared.stop()
        WalletClient.shared.resetServiceUrl(baseUrl: ApplicationManager.default.walletServiceUrl)
    ...
    func rollbackServiceUrl(serviceUrl: String) {
        ApplicationManager.default.walletServiceUrl = serviceUrl
