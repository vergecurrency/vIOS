...
class ShortcutsManager: NSObject {
    ...
    private(set) var lastShortcutType: String? = nil
    ...
    func proceedAppDidFinishLaunch(_ application: UIApplication, withOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
    ...
    func updateShortcuts() {
        ...
        if application!.shortcutItems != nil {
            // Check wallet setup
            let hasWallet = ApplicationRepository.default.setup
